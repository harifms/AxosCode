...
accDetails = {
    ...
    "accountStatus": apiResponse.status || "",
...
if (isPresent(apiResponse.individualHolder)) {
  let owner = {
    ...
    "citizenshipStatus": apiResponse.individualHolder.citizenship && apiResponse.individualHolder.citizenship.citizenshipStatus
        ...
        : "",
    "ssNOrTaxID": apiResponse.individualHolder.ssn ? apiResponse.individualHolder.ssn : "",
  ...
  if (apiResponse.individualHolder.contact) {
    if (apiResponse.individualHolder.contact.affiliationsGroup) {  
      ...
      let regulatoryDisclosuresV0 = {
        "employedBySecurityIndustryEntity": affiliationsGroup.nasdGroup ? affiliationsGroup.nasdGroup.nasd : null,
        ...
        "directorOrOfficerInPublicCompany": affiliationsGroup.companyGroup ? affiliationsGroup.companyGroup.publicCompany : null,
        ...
        "seniorMilitaryGovermentOrPoliticalOfficial": affiliationsGroup.foreignGroup ? affiliationsGroup.foreignGroup.foreignOfficial : null,
...
if (apiResponse.coHolders && isArray(apiResponse.coHolders)){
  ...
  for (let secondaryOwner of apiResponse.coHolders ){
      ...
      "citizenshipStatus": secondaryOwner.citizenship && secondaryOwner.citizenship.citizenshipStatus
          ...
          : "",
      "ssNOrTaxID": secondaryOwner.ssn ? secondaryOwner.ssn : "",
    ...
    if (secondaryOwner.contact) {
      if (secondaryOwner.contact.affiliationsGroup) {  
        ...
        let regulatoryDisclosuresV02 = {
          "employedBySecurityIndustryEntity": affiliationsGroup2.nasdGroup ? affiliationsGroup2.nasdGroup.nasd : null,
          ...
          "directorOrOfficerInPublicCompany": affiliationsGroup2.companyGroup ? affiliationsGroup2.companyGroup.publicCompany : null,
          ...
          "seniorMilitaryGovermentOrPoliticalOfficial": affiliationsGroup2.foreignGroup ? affiliationsGroup2.foreignGroup.foreignOfficial : null,
...
if (apiResponse.beneficiaries && isArray(apiResponse.beneficiaries)){
    ...
    for(let item of apiResponse.beneficiaries)  {
        ...
        let person = {
          ...
          "middleName":item.name.middleInitial,
